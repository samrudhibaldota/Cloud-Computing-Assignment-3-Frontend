...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://8ddmqo3yv3.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.photosPut = function (params, body, additionalParams) {
        ...
        // ❌ OLD (made x-amz-meta-customLabels required and threw your error)
        // apiGateway.core.utils.assertParametersDefined(params, ['x-amz-meta-customLabels'], ['body']);
    
        // ✅ NEW: no required params from `params` for this call
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var photosPutRequest = {
            verb: 'put'.toUpperCase(),
            path: pathComponent + uritemplate('/photos').expand(
                apiGateway.core.utils.parseParametersToObject(params, [])
            ),
            // you can leave this as-is; if params has x-amz-meta-customLabels it will be used,
            // otherwise headers from additionalParams.headers will be used.
